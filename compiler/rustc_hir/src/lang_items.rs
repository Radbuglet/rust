...
//  Variant name,            Name,                     Getter method name,         Target                  Generic requirements;
    ...
    InferBundleTrait,        sym::infer_bundle,            infer_bundle,            Target::Trait,         GenericRequirement::None;
    InferBundleForTrait,     sym::infer_bundle_for,        infer_bundle_for,        Target::Trait,         GenericRequirement::Exact(1);
    ...
    DerefCxContextRef,       sym::deref_cx_context_ref,    deref_cx_trait_context_ref, Target::AssocTy,    GenericRequirement::None;
