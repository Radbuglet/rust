...
pub enum DefKind {
    ...
    /// A context item.
    Context,
    /// The inference type generated by each `infer_bundle!` expansion.
    InferBundle,
}
...
impl DefKind {
    ...
    pub fn descr(self, def_id: DefId) -> &'static str {
        match self {
            ...
            DefKind::InferBundle => "inferred bundle",
        }
    }
    ...
    pub fn def_path_data(self, name: Symbol) -> DefPathData {
        match self {
            ...
            DefKind::InferBundle => DefPathData::InferBundle,
        }
    }
