...
impl<'tcx> EmbargoVisitor<'tcx> {
    ...
    fn update_macro_reachable_def(
        ...
        match def_kind {
            ...
            DefKind::Const | DefKind::Static { .. } | DefKind::Context | DefKind::TraitAlias | DefKind::TyAlias => {
...
impl<'tcx> Visitor<'tcx> for EmbargoVisitor<'tcx> {
    fn visit_item(&mut self, item: &'tcx hir::Item<'tcx>) {
        ...
        match item.kind {
            ...
            hir::ItemKind::Mod(..) | hir::ItemKind::OpaqueTy(..) | hir::ItemKind::InferBundle => {}
...
impl<'tcx> Visitor<'tcx> for TypePrivacyVisitor<'tcx> {
    ...
    fn visit_qpath(&mut self, qpath: &'tcx hir::QPath<'tcx>, id: hir::HirId, span: Span) {
        ...
        let def = def.filter(|(kind, _)| {
            matches!(
                kind,
                DefKind::AssocFn | DefKind::AssocConst | DefKind::AssocTy | DefKind::Static { .. } | DefKind::Context
            )
        });
...
impl<'tcx> PrivateItemsInPublicInterfacesChecker<'_, 'tcx> {
    ...
    fn check_item(&mut self, id: ItemId) {
        ...
        match def_kind {
            DefKind::Const | DefKind::Static { .. } | DefKind::Context | DefKind::Fn | DefKind::TyAlias => {
